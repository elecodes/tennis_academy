...
def add_demo_data():
    ...
    print("\nAdding demo groups...")
    groups = [
        ('Beginners Mon/Wed', 'Monday & Wednesday 4:00-5:30 PM', coach_ids[0], 'Ages 5-7, beginner level'),
        ('Intermediate Tue/Thu', 'Tuesday & Thursday 4:00-5:30 PM', coach_ids[0], 'Ages 8-10, intermediate level'),
        ('Advanced Mon/Wed', 'Monday & Wednesday 5:30-7:00 PM', coach_ids[1], 'Ages 11-14, advanced level'),
        ('Weekend Warriors', 'Saturday 9:00-11:00 AM', coach_ids[1], 'All ages, recreational'),
    ]
