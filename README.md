...
- ✅ **Supabase Integration** (PostgreSQL read layer for students, enrollments, users, coach groups, timetable, and messaging)
...
✅ Supabase Layer:  Coach groups, timetable, and messaging via Supabase REST API (v1.22.0)
